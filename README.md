...
## Data 2022, 2023 (Efficiency) - uGT L1 emul
...
HLTAnalyzerEndpath \
 ...
 --max-events -1 \
 --customise \
HLTrigger/Configuration/MuonHLTForRun3/customizeMuonHLTForRun3.enableChainingIOfromL1 \
 --full --offline --no-output >hlt_muon_data_chaining.py
...
hltGetConfiguration /dev/CMSSW_14_0_0/GRun/V27 \
 --process MYHLT \
 --data --globaltag 140X_dataRun3_HLT_for2024TSGStudies_v1 \
 --eras Run3 --timing \
...
hltGetConfiguration /dev/CMSSW_14_0_0/GRun/V27 \
 ...
 --eras Run3 --timing \
 --customise \
HLTrigger/Configuration/MuonHLTForRun3/customizeMuonHLTForRun3.disablePixelHitsOI \
 --full --offline --output minimal >hlt_muon_data_Timing_noPixelHitsOI.py
...
hltGetConfiguration /dev/CMSSW_14_0_0/GRun/V27 \
 ...
 --customise \
HLTrigger/Configuration/MuonHLTForRun3/customizeMuonHLTForRun3.enableChainingIOfromL1 \
 --full --offline --output minimal >hlt_muon_data_Timing_chaining.py
...
# Full L1 emulation : --eras Run3 --l1-emulator FullMC --l1 L1Menu_Collisions2024_v1_0_0_xml \
...
cmsRun hlt_muon_data_chaining.py
...
## Test run
cat after_menu_data.sh >> hlt_muon_data.py
sed -i 's/numberOfThreads = 4/numberOfThreads = 1/g' hlt_muon_data.py
cmsRun hlt_muon_data.py

cat after_menu_mc.sh >> hlt_muon_mc.py
